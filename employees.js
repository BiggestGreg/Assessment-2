...
class Employee {
    ...
    getSchedule = () => `${this.name} works ${this.shifts}`
}
...
//CODE HERE
const empOne = new Employee("Greg", ['Monday', 'Tuesday', 'Wednesday', 'Friday', 'Saturday'])
/*
...
//CODE HERE
const empTwo = new Employee("Nick", ['Wednesday', 'Friday', 'Saturday', 'Sunday', 'Monday']);
...
//CODE HERE
const manager = new Manager('Winston', ['weeday mornings', 'weekday afternoons'], ['Cece', 'Shmidt']);
